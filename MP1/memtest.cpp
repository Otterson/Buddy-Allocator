...
int main(int argc, char *argv[])
{
  ...
  size_t block_size = (int)(*argv[0]);            /* 1kB -- CHANGE THIS! */
  size_t mem_size = (int)(*argv[1]) * block_size; /* 1MB -- CHANGE THIS! */
...
void ackerman_main(size_t _block_size, size_t _mem_size)
{
  ...
  */
  ...
  for (;;)
  { /* Loop forewer, or until we break. */
    ...
    cout << "Enter 0 for either 'a' or 'b' in order to exit" << endl
         << endl;
